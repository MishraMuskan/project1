...
array.forEach(function (val, idx) {
 ...
 <div id="likes">
     <div id="leftl"> <i class="ri-heart-line"></i>
...
document.querySelector("#box").innerHTML = clutter1;
 ...
 var love = document.querySelector("#post");
love.addEventListener('dblclick', function () {
    document.querySelector("#heart >img").style.display = "flex";
    // setTimeout(function () {
    //     document.querySelector("#heart img").style.op= "none";
    // }, 2000)
})
